...
<section class="section">
  <div class="card">
        ...
        <div class="col-12">
            ...
            <div class="card-body"> 
                <form class="{{ route('caripengaduantgl') }}" method="POST">
                @csrf
                <div class="row">
                    <div class="col-sm-5 col-12">
                    <div class="form-group">
                        <label for="tgl_awalpengaduan">Dari Tanggal</label>
                        <input type="date" id="tgl_awalpengaduan" name="tgl_awalpengaduan" class="form-control" 
                            value="{{ old('tgl_awalpengaduan') }}">
                    </div>
                    </div>
                    ...
                    <div class="form-group">
                                    ...
                                    <input type="date" id="tgl_akhirpengaduan" name="tgl_akhirpengaduan" class="form-control" 
                                    value="{{ old('tgl_akhirpengaduan') }}">
                                </div>
                    </div>
        ...
        <div class="col-12">
            ...
            @if($cetakTglPengaduan ?? '')
                ...
                <div class="col-sm-12 d-flex justify-content-end">
                    <a href="{{ route('laporanpengaduanpdf', ['tgl_awalpengaduan' => $tgl_awalpengaduan, 'tgl_akhirpengaduan' => $tgl_akhirpengaduan ]) }}"  
                    target="_blank" class="btn btn-primary btn-sm me-1 mb-1"><i class="fa fa-print fa-3px"></i> Print</a>
                </div>
                @endif
                        ...
                        @foreach( $cetakTglPengaduan as $semuaPengaduan )
                            <tr>
                                ...
                                <td width="150px" >
                                    ...
                                    @else ($semuaPengaduan->status =='Tidak Aktif')
                                    <p>Tidak Aktif</p>
...
<div class="modal fade" id="detail{{ $semuaPengaduan->id }}" tabindex="-1" role="dialog"
                    ...
                    <div class="row">
                        <div class="form-group col-md-6 col-12">
                          <label for="tgl_pengaduan" style="color:#000;">Tanggal Pengaduan</label>
                            <p type="text" class="form-control-plaintext" id="tgl_pengaduan" name="tgl_pengaduan" 
                            readonly value="">{{ \Carbon\Carbon::parse($semuaPengaduan->tgl_pengaduan)->format('d M Y') }}</p>
                        </div>
                   
                        <div class="form-group col-md-6 col-12">
                          <label for="pemohon_id" style="color:#000;">Nama Pemohon</label>
                          <p class="form-control-plaintext" id="pemohon_id" name="pemohon_id" 
                          value="" readonly>{{ $semuaPengaduan->pemohon->nama }}</p>
                        </div>

                        <div class="form-group col-md-6 col-12">
                          <label for="tgl_verifikasi" style="color:#000;">Tanggal Verifikasi</label>
                          <p class="form-control-plaintext" id="tgl_verifikasi" name="tgl_verifikasi" 
                          value="" readonly>{{ \Carbon\Carbon::parse($semuaPengaduan->tgl_verifikasi)->format('d M Y') }}</p>
                        </div>
                        ...
                        <div class="form-group col-md-6 col-12">
                          ...
                          value="{{ $semuaPengaduan->pemohon->username }}" readonly>
                        </div>
                    </div>
                        ...
                        <label for="pegawai_id" style="color:#403e3e; font-weight:bold;">Diverifikasi oleh</label>
                            ...
                            value="">{{ $semuaPengaduan->pegawai['nama'] }} | <b>Username: {{ $semuaPengaduan->pegawai['username'] }}</b></p>
                        </div>
