@extends('layout.main')
@section('title', 'Detail Pengaduan Selesai | Sistem Pengaduan DPMPTSP Kabupaten BADUNG')
@section('header', 'Detail Pengaduan Selesai Diproses')
@section('content')
...
@endif
        ...
        <div class="card">
            <div class="card-body">
                      ...
                      <form action="/pengaduan/detail-selesai/{{ $selesai->id }}" method="POST">
                      @csrf
                      @method('PATCH')
                    ...
                    <div class="row">
                        <div class="col-md-10 col-12">
                            ...
                            <label for="kategori" style="color:#000;">Kategori Pengaduan</label>
                                <p type="text" class="form-control-plaintext" id="kategori" name="kategori">{{ $selesai->kategori }}</p>
                            </div>
                        </div>

                        <div class="col-md-2 col-12">
                            <p style="font-size:14px;">ID. Pengaduan: #{{ $selesai->id }}</p>
                        </div>
                    </div>

                        <div class="form-group">
                          <label for="judul" style="color:#000;">Judul Pengaduan</label>
                            <p type="text" class="form-control-plaintext" id="judul" name="judul">{{ $selesai->judul }}</p>
                        </div>
                        
                        <div class="form-group">
                          <label for="deskripsi" style="color:#000;">Deskripsi</label>
                          <p type="text" class="form-control-plaintext" id="deskripsi" name="deskripsi" style="text-align:justify;">{{ $selesai->deskripsi }}</p>
                        </div>    
                    ...
                    <div class="row">
                        <div class="form-group col-md-6 col-12">
                          <label for="tgl_pengaduan" style="color:#000;">Tanggal Pengaduan</label>
                            ...
                            onfocusin="(this.type='date')" onfocusout="(this.type='text')" readonly disabled value="{{ \Carbon\Carbon::parse($selesai->tgl_pengaduan)->format('d M Y') }}">
                        </div>
                        ...
                        <div class="form-group col-md-6 col-12">
                          ...
                          value="{{ $selesai->pemohon->nama }}" readonly disabled>
                        </div>
                        ...
                        <div class="form-group col-md-6 col-12">
                          ...
                          <input type="text" class="form-control-plaintext" id="tgl_verifikasi" name="tgl_verifikasi"
                           value="{{ \Carbon\Carbon::parse($selesai->tgl_verifikasi)->format('d M Y') }}" readonly disabled>
                        </div>

                        <div class="form-group col-md-6 col-12">
                          <label for="pemohon_id" style="color:#000;">Username Pemohon</label>
                          <input type="text" class="form-control-plaintext" id="pemohon_id" name="pemohon_id" 
                          value="{{ $selesai->pemohon->username }}" readonly disabled>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6 col-12" style="float:right">
                          ...
                          <p type="text" class="form-control-plaintext" id="pegawai_id" name="pegawai_id" 
                          value="">{{ $selesai->pegawai['namabidang'] }}</p>
                        </div>
                    </div>
                    ...
                    <div class="form-group col-md-6 col-12">
                            ...
                            <input type="text" class="badge bg-success" id="status" name="status" 
                              value="{{ $selesai->status }}" readonly>
                            <!-- @if ( $selesai->status == 'Selesai')
                                <span class="badge bg-success">Selesai</span>
                            @endif -->
                            <select name="status" class="form-select @error('status') is-invalid @enderror">
                                <option value="{{ $selesai->status }}">{{ $selesai->status }}</option>
                        ...
                        <div class="form-group">
                          ...
                          name="tanggapan" placeholder="Tuliskan tanggapan Verifikator" rows="8">{{ $selesai->tanggapan }}</textarea>
                        </div>
                        <!-- end tampil data -->

                        
                        <div class="col-12 d-flex justify-content-end mt-2">
                            <a href="{{ url('pengaduan/selesai') }}" class="btn btn-dark btn-sm me-1 mb-1">Kembali</a>
